                        ...
                        foreach ($resInv["items"] as $item) {?>
                            ...
                            <tr data-index="0">
                                ...
                                <td class="text-center">
                                    <a title="Принять?" href="/invite/change_status/status/1/ID/<? echo $item["ID"] ?>" class="ml5 glyphicon glyphicon-ok-sign"></a>
                                    <a title="Октлонить?" href="/invite/change_status/status/2/ID/<? echo $item["ID"] ?>" class="ml5 glyphicon glyphicon-remove-sign"></a>
